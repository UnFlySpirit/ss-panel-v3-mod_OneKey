...
#常规变量
update_time="2019年01月20日21:15:00"
...
echo -e "\033[31m#1.  一键ss-panel-v3-mod_UIChanges搭建                      #\033[0m"
echo -e "\033[32m#2.  一键ss-panel-v3-mod_UIChanges搭建(不安装lnmp)          #\033[0m"
echo -e "\033[33m#3.  一键添加SS-panel节点[新版]                             #\033[0m"
echo -e "\033[35m#4.  一键添加SS-panel节点                                   #\033[0m"
echo -e "\033[36m#5.  一键  BBR加速  搭建                                    #\033[0m"
echo -e "\033[37m#6.  一键锐速破解版搭建                                     #\033[0m"
echo -e "\033[33m#                                PS:建议先搭建加速再搭建面板#\033[0m"
echo -e "\033[32m#                                   支持   Centos  7.x  系统#\033[0m"
echo -e "\033[32m#                                   支持   Ubutun  x.x  系统#\033[0m"
echo -e "\033[31m#############################################################\033[0m"
echo
read -p "请选择你要安装的项目：" num
if [[ $num == "1" ]]
then
install_Main
elif [[ $num == "2" ]]
